...
## Current status (2026-09-11, chain at spec 455, corpus at spec 452)
...
- **The seven-day volume read on `rotation-signal-gate`, due 2026-09-16.**
  ...
  the honest read.
- **The corpus is three chain releases behind** (grounded at 452, chain at
  455). `network-drift-455` is proposed but not drafted. See
  `knowledge/corpus/SOURCES.md` for exactly which claims are incomplete.
