...
dashboard) — implemented, tested, and committed, with one open item: the
dashboard is not yet reachable from the operator's browser (see the
capability table). Investment/rotation tooling is Phase 7 territory.
