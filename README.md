...
chain-parameter watch; Telegram pulse + subnt.dev public edition (data
files since 2026-09-26, see `subnt-publish` below).
The 455 switch
...
| `knowledge-base` | Done — corpus grounded at Finney spec **469** (2026-09-24): pool-side switch distinct from the bar (off 29/35/36/108), `set_root_weights` retired and `BasketConcentrationCap` 4096, rank-pinned bar. 36-exchange battery; last accepted run `20260924T070006Z-265dfc08` on `grok-4.6` (0.92, 23/25 grounded, on the floor) against corpus run `20260924T034531Z-66329b35` |
...
- **Scheduled jobs are user-level systemd units** in
  ...
  `atlas-subnt`. Install with `systemctl --user`. Only
