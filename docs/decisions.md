...
- **Conviction-activation conflict**: repo evidence recorded 2026-07-12
  (see the Phase 3 evidence-check entry above): activation code merged
  2026-06-30 (spec 425) — the corpus claim is superseded at source level.
  Remaining: (a) upstream corpus correction in `intoops-routines` + the
  documented re-sync/re-ingest/re-approve flow to update the `conflicting`
  unit; (b) optional chain confirmation of the enactment date (mainnet
  spec_version ≥ 425) when Phase 4 live-data adapters exist.
